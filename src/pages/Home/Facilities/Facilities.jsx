...
const facilities = [
  {
    name: "24/7 Concierge",
    description:
      "Our dedicated team is always on hand to assist with your needs, from package handling to booking services.",
    icon: (
      <svg
        className="w-12 h-12 text-indigo-400 group-hover:text-indigo-300 transition-colors duration-300"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Relax and unwind with stunning city views from our beautifully landscaped rooftop terrace, complete with seating and a fire pit.",
    icon: (
      <svg
        className="w-12 h-12 text-pink-400 group-hover:text-pink-300 transition-colors duration-300"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
  ...
  },
  {
    ...
    description:
      "Boost your productivity in our modern co-working lounge, featuring high-speed Wi-Fi, private desks, and meeting rooms.",
    icon: (
      <svg
        className="w-12 h-12 text-indigo-400 group-hover:text-indigo-300 transition-colors duration-300"
        fill="none"
  ...
  },
  {
    name: "Fitness Center",
    description:
      "Stay healthy and active with our state-of-the-art fitness center, equipped with modern cardio and weight training machines.",
    icon: (
      <svg
        className="w-12 h-12 text-pink-400 group-hover:text-pink-300 transition-colors duration-300"
        fill="none"
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M14 10h4.764a2 2 0 011.789 2.894l-5 10A2 2 0 0114 22H4a2 2 0 01-2-2V6a2 2 0 012-2h2"
        />
      </svg>
    ),
  },
